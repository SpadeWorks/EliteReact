                    ...
                    <div className="row test_drive">
                        ...
                        <div className="col-md-12 leader_box">
                          ...
                          <div className="col-md-12 leader_name">
                            <div className="avatar">
                              <img src="/Style%20Library/Elite/images/masc1.png" className="img-responsive"
                              />
                            </div>
                      ...
                      <a href="#">
                        <div className="col-md-12 leader_box">
                          ...
                          <div className="col-md-12 leader_name">
                            <div className="avatar">
                              <img src="/Style%20Library/Elite/images/masc2.png" className="img-responsive"
                              />
                            </div>
                            <div className="col-md-9 l_count_box">
                              <div className="col-md-12 name">
                      ...
                      <a href="#">
                        <div className="col-md-12 leader_box">
                          ...
                          <div className="col-md-12 leader_name">
                            <div className="avatar">
                              <img src="/Style%20Library/Elite/images/masc3.png" className="img-responsive"
                              />
                            </div>
                            <div className="col-md-9 l_count_box">
                              <div className="col-md-12 name">
