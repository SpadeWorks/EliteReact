...
class Navigation extends React.Component<NavigationProps> {
    ...
    openPopUp() {
        var options = {
            url: '/sites/elite-dev-akash/Pages/referral.aspx',
            title: 'User Referral',
            width: 600,
            height: 600,
        };
    ...
    render() {
        return (<div className="col-md-8 location_box">
            <div className="map_container">
                <object>
                    <img src="/sites/elite-dev-akash/Style%20Library/Elite/images/track.svg" />
                    <Link className="maplinks" to={"/testdrives"} id="link1">
                        <img src="/sites/elite-dev-akash/Style%20Library/Elite/images/testdrivecenter.png" />
                        <span>test drieves central</span>
                    </Link>

                    <a className="maplinks" id="link2" href="javascript:;" onClick={this.openPopUp}>
                        <img src="/sites/elite-dev-akash/Style%20Library/Elite/images/refer.png" />
                    ...
                    <Link className="maplinks" to={"/prizes"} id="link4">
                        <img src="/sites/elite-dev-akash/Style%20Library/Elite/images/Prizes.png" />
                        <span>Prizes</span>
                    </Link>
                    <Link className="maplinks" to={"/leaderboard"} id="link5">
                        <img src="/sites/elite-dev-akash/Style%20Library/Elite/images/leaderboard.png" />
                        <span>Leaderboard</span>
                    </Link>
                    <a data-toggle="modal" data-target="#exampleModal" id="link6" className="maplinks">
                    <img src="/sites/elite-dev-akash/Style%20Library/Elite/images/video.png" />
                    <span>Video</span></a>
                </object>
            </div>
        </div>)
