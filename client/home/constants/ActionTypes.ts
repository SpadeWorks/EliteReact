...
export const LOAD_TotalUserCount_FULFILLED = 'LOAD_TotalUserCount_FULFILLED';

export const LOAD_UserPoints = 'LOAD_UserPoints';
export const LOAD_UserPoints_PENDING = 'LOAD_UserPoints_PENDING';
export const LOAD_UserPoints_FULFILLED = 'LOAD_UserPoints_FULFILLED';

export const LOAD_TestDriveCompleted = 'LOAD_TestDriveCompleted';
export const LOAD_TestDriveCompleted_PENDING = 'LOAD_TestDriveCompleted_PENDING';
export const LOAD_TestDriveCompleted_FULFILLED = 'LOAD_TestDriveCompleted_FULFILLED';

export const LOAD_TotalTestDrives = 'LOAD_TotalTestDrives';
export const LOAD_TotalTestDrives_PENDING = 'LOAD_TotalTestDrives_PENDING';
export const LOAD_TotalTestDrives_FULFILLED = 'LOAD_TotalTestDrives_FULFILLED';

export const LOAD_TotalTasks = 'LOAD_TotalTasks';
export const LOAD_TotalTasks_PENDING = 'LOAD_TotalTasks_PENDING';
export const LOAD_TotalTasks_FULFILLED = 'LOAD_TotalTasks_FULFILLED';
...
export const LOAD_EliteProfile = 'LOAD_MyEliteProfile';
export const LOAD_EliteProfile_PENDING = 'LOAD_MyEliteProfile_PENDING';
export const LOAD_EliteProfile_FULFILLED = 'LOAD_MyEliteProfile_FULFILLED';
export const LOAD_EliteProfile_REJECTED = 'LOAD_MyEliteProfile_REJECTED';
