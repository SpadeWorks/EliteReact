...
interface AppProps {
    id: number,
    testDrive: model.TestDriveInstance;
    testDrives: model.TestDriveInstance[];
...
class TestDriveParticipation extends React.Component<AppProps> {
    ...
    componentDidMount() {
        ...
        // }
        // this.props.dispatch(loadTestDriveInstanceByID(this.props.id || -1));
    }
...
export default connect(mapStateToProps)(TestDriveParticipation);